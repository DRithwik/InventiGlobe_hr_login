...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    try {
        $stmt = $pdo->prepare("INSERT INTO employees (emp_id, emp_name, emp_phone, emp_role, emp_gmail, emp_join_date) 
                              VALUES (?, ?, ?, ?, ?, ?)");
        ...
        header("Location: ../dashboard.php?section=employees&message=Employee added successfully");
        exit();
